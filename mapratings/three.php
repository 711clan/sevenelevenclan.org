...
define('MR_DBHOST', '75.102.39.220');
define('MR_DBUSER', 'maprate');
define('MR_DBPASS', 'anend82nl3nasdHD8H3njazoei9');
define('MR_DBNAME', 'maprateTF2Extacy');
...
class MapRating {
    ...
    function get_table() {
        return "\t<tr>\n"
            ."\t\t<td class=ratings1>{$this->name}</td><td class=ratings2>{$this->get_average()}</td> "
            ."<td class=ratings3>{$this->get_num_ratings()}</td>\n"
            ."\t</tr>\n";
	}
...
class MapRatings {
    ...
    function get_ratings_table() {
        ob_start();
        echo "<table><tr><td><b>Map Name</b></td><td><b>Average</b></td><td><b>Ratings</b></td></tr>\n";
            $cell = 0;
